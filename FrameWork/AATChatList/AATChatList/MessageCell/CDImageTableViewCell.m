...
-(void)initLeftImageContent{
    ...
    [self.msgContent_left aat_setShowActivityIndicatorView:YES];
    [self.msgContent_left aat_setIndicatorStyle:UIActivityIndicatorViewStyleGray];
...
-(void)initRightImageContent{
    ...
    [self.msgContent_right aat_setShowActivityIndicatorView:YES];
    [self.msgContent_right aat_setIndicatorStyle:UIActivityIndicatorViewStyleGray];
...
-(void)configImage_Left:(CDChatMessage)data {
    ...
    if (image) {
        ...
        [self.imageContent_left aat_setImageWithURL:[NSURL URLWithString:data.msg] placeholderImage:nil completed:^(UIImage * _Nullable image, NSError * _Nullable error, AATImageCacheType cacheType, NSURL * _Nullable imageURL) {
...
-(void)tapContent:(UITapGestureRecognizer *)tap {
    ...
    info.image = [[AATImageCache sharedImageCache] imageFromCacheForKey:self.msgModal.msg];
